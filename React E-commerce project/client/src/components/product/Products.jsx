            ...
            <div className="container-fluid py-5 bg-gray">
                <div className="row">
                    <div className="text-center mb-5">
                        ...
                        <span className="text-muted">Explore a World of Choices Across Our Most Popular</span>
                                                                ...
                                                                <div key={item['_id']} className="col-md-3 p-2 col-lg-3 col-sm-6 col-12">
                                                                    <Link to={`/details/${item['_id']}`} className="card shadow-sm h-100 rounded-3 bg-white">
                                                                        ...
                                                                        <div className="card-body">
                                                                            ...
                                                                            {price}
                                                                            <StarRatings rating={parseFloat(item['star'])} starRatedColor="orange" starDimension="15px" starSpacing="2px" />
                                                                        </div>
                                                                    </Link>
                                                                </div>
                                                            )
